...
echo "============================================"
echo "Compiling Argmax-only testbench..."
...
for label in {0..9}; do
    ...
    echo "============================================"
    echo "Running ARGMAX ONLY for label ${label}"
    ...
    for n in {0..99}; do
        ...
        argmax_out="${out_dir}/img_${img_idx}_argmax.csv"
...
echo "============================================"
echo "DONE ARGMAX ONLY DATASET DUMP"
