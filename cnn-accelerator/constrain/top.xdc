...
set_property -dict { PACKAGE_PIN A11 IOSTANDARD LVCMOS33 } [get_ports cam_pclk]
set_property -dict { PACKAGE_PIN D12 IOSTANDARD LVCMOS33 } [get_ports {cam_d[7]}]
set_property -dict { PACKAGE_PIN D13 IOSTANDARD LVCMOS33 } [get_ports cam_reset]
...
## Pmod Header JB
set_property -dict { PACKAGE_PIN E15 IOSTANDARD LVCMOS33 } [get_ports cam_sda]
set_property -dict { PACKAGE_PIN E16 IOSTANDARD LVCMOS33 } [get_ports cam_href]
