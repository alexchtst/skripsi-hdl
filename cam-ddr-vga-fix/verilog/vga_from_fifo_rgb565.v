...
module vga_from_fifo_rgb565 (
    ...
    always @(posedge vga_clk) begin
        if (rst) begin
            ...
            // awal vertical blank, bagus untuk mulai DDR read
    ...
    localparam TEXT_LEN   = 12; // P R E D I C T E D : space digit

    // posisi tulisan, tidak lagi bergantung pada ROI
    ...
    function [7:0] get_text_char;
        ...
        begin
            case (idx)
                ...
                4'd7:  get_text_char = 8'h45; // E
                4'd8:  get_text_char = 8'h44; // D
                4'd9:  get_text_char = 8'h3A; // :
                4'd10: get_text_char = 8'h20; // space
                4'd11: begin
                    if (digit <= 4'd9)
